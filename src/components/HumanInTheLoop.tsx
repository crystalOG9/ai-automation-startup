    ...
    <section className="py-24 relative overflow-hidden bg-[#0A0A0A] perspective-1200">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-black tracking-tight text-[#F6EFF5] uppercase font-sans mb-6 leading-tight drop-shadow-[0_2px_14px_rgba(0,0,0,0.7)]">
