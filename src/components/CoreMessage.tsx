...
export function CoreMessage() {
  return (
    <section id="core-message" className="py-24 relative overflow-hidden bg-[#0B0B0B] perspective-1200">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 max-w-5xl mx-auto items-center preserve-3d">
          ...
          <motion.div
            ...
            viewport={defaultViewport}
            variants={fadeInLeft}
            className="glass-card p-8 rounded-3xl border border-white/[0.06] bg-[#141414] relative group transition-all duration-300 hover:border-[#C9AEC6]/40 shadow-xl"
          >
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {AI_TASKS.map((task, idx) => (
                <motion.div
                  ...
                  className="px-4 py-2 rounded-full bg-[#1A1A1A] border border-white/[0.06] text-[#8E8295] font-medium text-sm hover:bg-white/10 hover:text-[#F6EFF5] transition-colors cursor-default"
                >
                  {task}
                </motion.div>
              ))}
          ...
          <motion.div
            ...
            className="glass-card p-8 rounded-3xl border border-[#C9AEC6]/30 bg-[#161616] relative group transition-all duration-300 hover:border-[#C9AEC6]/60 shadow-xl"
          >
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {HUMAN_TASKS.map((task, idx) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.05, y: -2 }}
                  className="px-4 py-2 rounded-full bg-[#C9AEC6]/10 border border-[#C9AEC6]/30 text-[#F6EFF5] font-medium text-sm hover:bg-[#C9AEC6]/20 hover:text-white transition-colors cursor-default shadow-[0_0_15px_rgba(201,174,198,0.08)]"
                >
                  {task}
                </motion.div>
              ))}
